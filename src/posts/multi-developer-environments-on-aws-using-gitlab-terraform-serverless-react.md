...
![](/images/blog/multi-developer-environments-on-aws-using-gitlab-terraform-serverless-react/1_pYbWbcDpvZ7Ezb6VvYMUQg.png)
...
![Run Pipeline — Gitlab CI](/images/blog/multi-developer-environments-on-aws-using-gitlab-terraform-serverless-react/1_ul78U7dxq3zg7Nz9wROS7w.png)_Run Pipeline — Gitlab CI_

The result will be:

![Pipeline Running - Gitlab CI](/images/blog/multi-developer-environments-on-aws-using-gitlab-terraform-serverless-react/1_bkmGgBrx2d3dcT2SmTjN3g.png)_Pipeline Running - Gitlab CI_
