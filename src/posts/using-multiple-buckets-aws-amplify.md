...
![[https://docs.amplify.aws/lib/storage/upload/q/platform/js](https://docs.amplify.aws/lib/storage/upload/q/platform/js)](/images/blog/using-multiple-buckets-aws-amplify/1_OaX89AxEY1lWu6DGeUTLcw.png)*[https://docs.amplify.aws/lib/storage/upload/q/platform/js](https://docs.amplify.aws/lib/storage/upload/q/platform/js)*
...
![[https://github.com/aws-amplify/amplify-js/blob/master/packages/storage/src/Storage.ts](https://github.com/aws-amplify/amplify-js/blob/master/packages/storage/src/Storage.ts)](/images/blog/using-multiple-buckets-aws-amplify/1_6HmaJE2CULUp18LMsf69yA.png)*[https://github.com/aws-amplify/amplify-js/blob/master/packages/storage/src/Storage.ts](https://github.com/aws-amplify/amplify-js/blob/master/packages/storage/src/Storage.ts)*
...
![](/images/blog/using-multiple-buckets-aws-amplify/1_PVFMki2IqoMuCJ7GhkPpug.png)
